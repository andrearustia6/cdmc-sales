...
namespace Sales.Controllers
{
    public class CompanyMergeController : Controller
    {
        ...
        public ActionResult MergeLead(AjaxMergeLead mergelead)
        {
            ...
            lead.Name_CH = mergelead.lead.Name_CN;
            lead.Name_EN = mergelead.lead.Name_EN;
            lead.Gender = mergelead.lead.Gender;
            lead.Title = mergelead.lead.Title;
            lead.Address =mergelead.lead.Address;
            lead.Birthday = mergelead.lead.Birthday;
            lead.Contact = mergelead.lead.Telephone;
            ...
            lead.Gender = mergelead.lead.Gender;
            lead.Mobile = mergelead.lead.CellPhone;
