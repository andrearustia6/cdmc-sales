            ...
            if (btnExport == "export")
            {
                ...
                if (EmployeeList.Count() > 0)
                {
                    ...
                    foreach (var item in EmployeeList)
                    {
                        ...
                        writer.Write(",");
                        writer.Write("\"");
                        writer.Write(string.Format("{0:p0}", item.ResponsibilityDisp));
                        writer.Write("\"");
                        writer.Write(",");
                        writer.Write("\"");
                        writer.Write(string.Format("{0:p0}", item.DisciplineDisp));
                        writer.Write("\"");
                        writer.Write(",");
                        writer.Write("\"");
                        writer.Write(string.Format("{0:p0}", item.ExcutionDisp));
                        writer.Write("\"");
                        writer.Write(",");
                        writer.Write("\"");
                        writer.Write(string.Format("{0:p0}", item.TargetingDisp));
                        writer.Write("\"");
                        writer.Write(",");
                        writer.Write("\"");
                        writer.Write(string.Format("{0:p0}", item.SearchingDisp));
                        writer.Write("\"");
                        writer.Write(",");
                        writer.Write("\"");
                        writer.Write(string.Format("{0:p0}", item.ProductionDisp));
                        writer.Write("\"");
                        writer.Write(",");
                        writer.Write("\"");
                        writer.Write(string.Format("{0:p0}", item.PitchPaperDisp));
                        writer.Write("\"");
                        writer.Write(",");
                        writer.Write("\"");
                        writer.Write(string.Format("{0:p0}", item.WeeklyMeetingDisp));
                        writer.Write("\"");
                        writer.Write(",");
                        writer.Write("\"");
                        writer.Write(string.Format("{0:p0}", item.MonthlyMeetingDisp));
                        writer.Write("\"");
                        writer.Write(",");
                        writer.Write("\"");
                        writer.Write(string.Format("{0:p0}", item.Calllist));
                        writer.Write("\"");
                        writer.Write(",");
                        writer.Write("\"");
                        writer.Write(string.Format("{0:p0}", item.AddLeads));
                        writer.Write("\"");
                        writer.Write(",");
                        writer.Write("\"");
                        writer.Write(string.Format("{0:p0}", item.CheckIn));
                        writer.Write("\"");
                        writer.Write(",");
                        writer.Write("\"");
                ...
                if (TlList.Count() > 0)
                {
                    ...
                    foreach (var item in TlList)
                    {
                        ...
                        writer.Write(",");
                        writer.Write("\"");
                        writer.Write(string.Format("{0:p0}", item.CheckinScore / 100));
                        writer.Write("\"");
                        writer.Write(",");
                        writer.Write("\"");
                        ...
                        writer.Write(",");
                        writer.Write("\"");
                        writer.Write(string.Format("{0:p0}", item.AddLeadScore / 100));
                        writer.Write("\"");
                        writer.Write(",");
                        writer.Write("\"");
                        ...
                        writer.Write(",");
                        writer.Write("\"");
                        writer.Write(string.Format("{0:p0}", item.FaxCallScore / 100));
                        writer.Write("\"");
                        writer.Write(",");
                        writer.Write("\"");
                        writer.Write(string.Format("{0:p0}", item.AssignedScore / 100));
                        writer.Write("\"");
                        writer.Write(",");
                        writer.Write("\"");
                        writer.Write(item.Rate);
